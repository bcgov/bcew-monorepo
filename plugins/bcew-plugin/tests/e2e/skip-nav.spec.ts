...
test.describe( 'SkipNav', () => {
     ...
     *
     * @param {Editor} editor - The editor instance whose preview page should be focused.
     * @return {Promise<Page>} A promise that resolves to the preview page.
     */
    const openPreviewAndSetFocus = async (
        editor: Editor
    ): Promise< Page > => {
