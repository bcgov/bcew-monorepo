 ...
 * @return {Element} Navigation inner blocks list.
 */
const NavigationInnerBlocks = ( { isMenuOpen, shouldShowHamburger } ) => {
 ...
 * @return {Element} Navigation block editor interface
 */
const Edit = ( { attributes, setAttributes } ) => {
    ...
    const shouldShowHamburger =
        'mobile' === overlayMenu || 'always' === overlayMenu;
    ...
    const handleVisibilityToggle = ( toggleType, value ) => {
        if ( 'desktop' === toggleType ) {
            setAttributes( {
                showInDesktop: value,
                showInMobile: ! value,
            } );
        } else if ( 'mobile' === toggleType ) {
            setAttributes( {
                showInMobile: value,
                showInDesktop: ! value,
            } );
