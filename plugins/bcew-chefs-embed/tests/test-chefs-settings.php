...
class ChefsSettingsTest extends \WP_UnitTestCase {
	...
	public function test_handle_save_extracts_form_id_from_url() {
		$form_url = 'https://submit.digital.gov.bc.ca/app/form/manage?f=43cfb894-a0cf-4bef-8026-7c8001e3cdf5';
		...
		$this->assertIsArray( CredentialsManager::get_by_form_id( '43cfb894-a0cf-4bef-8026-7c8001e3cdf5' ) );
	...
	public function test_handle_save_extracts_form_id_before_url_fragment() {
		$form_url = 'https://submit.digital.gov.bc.ca/app/form/manage?f=43cfb894-a0cf-4bef-8026-7c8001e3cdf5#section';
		// phpcs:disable WordPress.Security.NonceVerification.Missing -- Tests simulate a POST request and set a valid nonce below.
		$_POST['form_id']     = $form_url;
		$_POST['api_key']     = $this->api_key;
		$_POST['_wpnonce']    = wp_create_nonce( 'bcew_chefs_save' );
	...
	public function test_handle_save_preserves_non_url_form_id() {
		$form_id    = 'not-a-url?f=43cfb894-a0cf-4bef-8026-7c8001e3cdf5';
	...
	/**
	 * Handle save preserves a direct form ID.
	 *
	 * @return void
	 */
