...
- [Document Repository](./bcew-document-repository-feature) — upload, edit, search, trash, revisions, and view modes
...
Front-end/document behavior (search permalink override, title augmentation, publish after untrash) lives in `/bcew-document-repository.php`
...
- App entry: `/assets/js/apps/bcew-document-repository/index.js`
- Main app: `/assets/js/apps/bcew-document-repository/App.js`
...
Namespace from config: `RepositoryConfig::get_api_namespace` in (src/RepositoryConfig.php) (default: `bcew-document-repository/v1`).
...
- Search:
    ...
    - Logic in `bcew-document-repository.php`
