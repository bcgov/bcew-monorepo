...
const useMetadataManagement = ( {
    ...
    const handleEditMetadata = useCallback(
        ( document ) => {
            ...
            const convertTermNameToId = ( termValue, options ) => {
                ...
                if (
                    'number' === typeof termValue ||
                    ( 'string' === typeof termValue &&
                        /^\d+$/.test( termValue ) )
                ) {
                    return termValue;
                }
                ...
                const option = options.find(
                    ( opt ) =>
                        ( 'string' === typeof opt && opt === termValue ) ||
                        ( 'object' === typeof opt &&
                            ( opt.name === termValue ||
                                opt.label === termValue ) )
                );
            ...
            metadataFields.forEach( ( field ) => {
                ...
                if ( 'taxonomy' === field.type && field.multiple ) {
    ...
    const handleSaveMetadata = useCallback( async () => {
        ...
        try {
            ...
            if ( 'function' === typeof onUpdateDocuments ) {
