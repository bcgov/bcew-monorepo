...
class AdminUIManager {
    ...
    private function register_admin_scripts(): void {
        ...
        $js_file = $build_path . '/bcew-document-repository/index.js';
        ...
        $bcew_document_repository_asset = require $build_path . '/bcew-document-repository/index.asset.php';
        $metadata_settings_asset        = require $build_path . '/metadata-settings/index.asset.php';

        wp_register_script(
            'bcew-document-repository-app',
            $build_url . '/bcew-document-repository/index.js',
            $bcew_document_repository_asset['dependencies'],
            $bcew_document_repository_asset['version'],
            true
        );
        ...
        wp_register_script(
            'bcew-document-repository-metadata-app',
    ...
    public function render_repository_page(): void {
        ...
        echo '<div id="bcew-document-repository-app"></div>';
        echo '</div>';
    }
    ...
    public function render_metadata_settings_page(): void {
        ...
        echo '<div id="bcew-document-repository-metadata-app"></div>';
        echo '</div>';
    }
}
