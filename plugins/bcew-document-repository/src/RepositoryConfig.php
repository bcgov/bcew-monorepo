...
class RepositoryConfig {
    ...
    private array $settings = [
        ...
        'menu_slug'          => 'bcew-document-repository',
        'metadata_slug'      => 'bcew-document-repository-metadata',

        // Security settings.
        'nonce_key'          => 'bcew_document_repository_nonce',
        ...
        // REST API settings.
        'api_namespace'      => 'bcew-document-repository/v1',
        'per_page'           => 20,

        // Frontend scripts.
        'js_handle'          => 'bcew-document-repository',
        'css_handle'         => 'bcew-document-repository-index',
    ...
    public function __construct( array $overrides = [] ) {
        ...
        $this->settings = apply_filters( 'bcew_document_repository_settings', $this->settings );
    }
